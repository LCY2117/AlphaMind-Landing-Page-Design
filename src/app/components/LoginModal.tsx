        ...
        <>
          ...
          >
            ...
            <div className="p-8">
              ...
              <h2 className="text-xl font-bold am-text-primary text-center mb-2">欢迎来到 AlphaMind</h2>
              <p className="am-text-secondary text-center mb-8 text-sm">登录开启您的智能投资之旅</p>
              ...
              {loginMethod === 'wechat' && (
                ...
                >
                  ...
                  <div className="text-center space-y-2">
                    <p className="text-sm am-text-secondary">打开微信扫一扫</p>
                    <p className="text-xs am-text-tertiary">安全快捷登录 AlphaMind</p>
                  </div>
              ...
              {loginMethod === 'phone' && (
                ...
                >
                  <div>
                    <label className="block text-xs am-text-secondary mb-2">手机号码</label>
                    <input
                      type="tel"
                      value={phoneNumber}
